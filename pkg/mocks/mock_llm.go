...
// Source: github.com/klauern/notion-table-reader/pkg/llm (interfaces: LLMClient,OpenAIClient)
//
...
import (
	...
	llm "github.com/klauern/notion-table-reader/pkg/llm"
...
func (m *MockLLMClient) IdentifyTags(arg0 *llm.TagInput, arg1 []string) ([]string, error) {
	m.ctrl.T.Helper()
