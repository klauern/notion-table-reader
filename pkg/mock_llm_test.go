...
// Source: github.com/klauern/notion-table-reader/pkg (interfaces: LLMClient)
//
// Generated by this command:
//
//	mockgen -destination=mock_llm_test.go -package=pkg_test github.com/klauern/notion-table-reader/pkg LLMClient
//
